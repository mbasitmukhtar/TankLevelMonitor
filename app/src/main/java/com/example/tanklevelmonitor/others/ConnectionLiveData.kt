package com.example.tanklevelmonitor.others
...
class ConnectionLiveData(context: Context) : LiveData<Boolean>() {
    ...
    override fun onActive() {
        ...
        Log.d(TAG, "onActive: capabilities: $capabilities")
            ...
            if (hasInternetCapability == true) {
                ...
                CoroutineScope(Dispatchers.IO).launch {
                    ...
                    if (hasInternet) {
                        ...
                        Log.d(TAG, "onAvailable CoroutineScope: hasInternetCapability: $hasInternetCapability")
                        checkValidNetworks()
                    }
                }
            } else {
                Log.d(TAG, "onAvailable: hasInternetCapability: $hasInternetCapability")
                checkValidNetworks()
            }
        }
